...
public class DirectedEdgeNew {
     ...
     */
    public DirectedEdgeNew(int v, int w, double distance, int tempoMedio) {
    ...
    public String toString() {
        return (v + 1) + "->" + (w + 1) + " " + "Distance: " + String.format("%5.2f", distance) + "m" + " Average Time(Car): " + String.format("%5.2f", tempoMedio) + "s";
    }
